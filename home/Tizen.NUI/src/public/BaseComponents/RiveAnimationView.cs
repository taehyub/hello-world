...
namespace Tizen.NUI.BaseComponents
{
    ...
    public class RiveAnimationView : View
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public void SetAnimationTimeMode(string animationName, bool timeMode)
        {
            Interop.RiveAnimationView.SetAnimationTimeMode(SwigCPtr, animationName, timeMode);
        }

        [EditorBrowsable(EditorBrowsableState.Never)]
        public void SetAnimationTime(string animationName, float time)
        {
            Interop.RiveAnimationView.SetAnimationTime(SwigCPtr, animationName, time);
        }
    }
}
